...
C<>::D G=0;
#endif
public:using F=decltype(G);E(F a):G(a){}inline Z F(){X G;}inline E&Z+=(F a){G+=a;X*this;}inline E&Z-=(F a){G-=a;X*this;}};}namespace{inline void H(const char*a){
